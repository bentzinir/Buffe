...
class CONFIGURATION(object):
    ...
    def test_buf_line(self, itr, loss, abs_grad, abs_w, gamma):
        buf = '%s Training ctrlr 1: iter %d, loss: %s, grads: %s, weights: %s, gamma: %f\n' % \
            (datetime.datetime.now(), itr, loss, abs_grad, abs_w, gamma)
        return buf
