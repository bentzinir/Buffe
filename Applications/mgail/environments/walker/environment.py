...
class ENVIRONMENT(object):
    ...
    def _train_params(self):
        self.trained_model = None#'/home/llt_lab/Documents/repo/Buffe-fix/Applications/mgail/environments/walker/snapshots/2017-02-16-04-10-050000.sn' #None #'/home/nir/work/git/Buffe/Applications/mgail/environments/halfcheetah/snapshots/2016-11-26-20-13-578000.sn'
        self.train_mode = True
        self.train_flags = [0, 1, 1]  # [autoencoder, transition, discriminator/policy]
        self.expert_data = 'expert_data/er-2017-02-16-10-10.bin'
